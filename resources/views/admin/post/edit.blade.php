            ...
            <div class="card-body">
                <form action="{{route('admin.post.update', $post)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category_id" id="category_id" class="form-control">
                            ...
                            @foreach ($categories as $category)
                                <option @if($post->category != null && $post->category->id  == $category->id) selected @endif value="{{ $category->id }}">{{ $category->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" style="height: 400px" class="form-control ckeditor-classic">{{ $post->description }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="img-wrapper">
                            <img class="form-img" src="{{Storage::url($post->image)}}" alt="">
                        </div>
                    </div>
