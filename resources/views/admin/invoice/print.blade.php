                            ...
                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                <thead>
                                    <tr class="table-active">
                                        ...
                                        <th scope="col" style="text-align: start">Rate</th>
                                ...
                                <tbody id="products-list">
                                    @foreach (json_decode($invoice->items_arry) as $index=>$item)
                                        <tr>
                                            ...
                                            <td class="text-start">{{ $item->item_details }}</td>
                                            <td style="text-align: start">৳{{ $item->item_price }}</td>
                                            <td style="text-align: start">{{ $item->item_quantity }}</td>
                                            <td style="text-align: start">-৳{{ $item->item_discount }}</td>
                                            <td class="text-end">৳{{ $item->item_total_amount }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table><!--end table-->
                            ...
                            <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-end">৳{{ $invoice->cart_total }}</th>
                                    </tr>
                                    <tr  class="border-top border-top-dashed fs-15">
                                        <td>Paid Amount</td>
                                        <td class="text-end">৳{{ $invoice->cart_paid }}</td>
                                    </tr>
                                    <tr>
                                        <td>Due Amount</td>
                                        <td class="text-end">৳{{ $invoice->cart_due }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <!--end table-->
