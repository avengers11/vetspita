...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{route('admin.invoice.service.add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea style="height: 400px" class="form-control" name="description"></textarea>
                    </div>
