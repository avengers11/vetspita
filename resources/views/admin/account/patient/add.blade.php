    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{keywords()->Create ?? __('Create')}} {{keywords()-> Patient ?? __(' Patient')}}</h5>
            </div>
            <div class="card-body">
                <form action="{{route('admin.patient.store')}}" class="row" method="POST" enctype="multipart/form-data">
                    @csrf
