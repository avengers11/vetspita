                ...
                <div class="information-top {{ $dynamicClass }}">
                    <div class="box patient-name">
                        ...
                        @if (empty($pet) || $pet == null)
                            <select name="pet_name" id="all_pets" class="selectpicker title" data-live-search="true"
                                required>
                                <option value="">-</option>
                                @foreach ($pets as $item)
                                    <option value="{{ $item->name }}" data-id="{{ $item->id }}"
                                        data-subtext="{{ $item->unique_id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                        @else
                            <select name="pet_name" id="all_pets" class="selectpicker title" data-live-search="true"
                                ...
                                <option value="{{ $pet->name }}" data-id="{{ $pet->id }}"
                                    data-subtext="{{ $pet->unique_id }}">{{ $pet->name }}</option>
                            </select>
                        @endif
                    ...
                    <div class="box parents-name">
                        ...
                        <select name="owner_name" id="select_user" class="selectpicker title" data-live-search="true"
                            required>
                            <option value="">-</option>
                    ...
                    <div class="box">
                        ...
                        <textarea name="address" id="address" class="title"></textarea>
                    </div>
                        ...
                        <span class="details-content">
                            <div class="details-box" id="clinical-history">
                                ...
                                <p class="title d-flex gap-2 d-none" id="vaccinated-date">
                                    Vaccinated Date: <input type="date" name="vaccinated_date" id="">
                                </p>
                                <p class="title d-flex gap-2">
                                    Deworming:
                                ...
                                <p class="title d-flex gap-2 d-none" id="deworming-date">
                                    Deworming Date: <input type="date" name="deworming_date" id="">
                                </p>
                            ...
                            <div class="details-box" id="clinical-findings">
                                ...
                                <textarea name="clinical_findings" id="" class="title mb-0">Temperature: °F</textarea>
                            </div>
                            <div class="details-box" id="diagnosis-content">
                                <h2 class="headline"><span class="badge bg-danger hide-show-btn"
                                        data-name="diagnosis">Hide Now</span> Diagnosis:</h2>

                                <textarea name="diagnosis" id="" class="title mb-0"></textarea>
                            </div>

                            <div class="details-box" id="tests-suggestion">
                                <h2 class="headline"><span class="badge bg-danger hide-show-btn"
                                        data-name="tests-suggestion">Hide Now</span> Tests Suggestion:</h2>
                            ...
                            <div class="details-box" id="dr-advice">
                                ...
                                <textarea name="advice" id="" class="title mb-0"></textarea>
                            </div>
                        </span>
                    ...
                    <div class="medicine-wrapper">
                        ...
                        <div class="add-new-medicine d-flex">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#addMedicineModel"><i class="fa-solid fa-plus"></i></button>
                        </div>
                ...
                <form action="{{ route('admin.medicine.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="" class="form-label title">Quantity/Measure
                                        (Optional):</label>
