        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                @can('Lap Diognosis Add')
                    <a href="{{ route('admin.lab-diognosis.biochemical.add') }}" class="btn btn-primary btn-label rounded-pill btn-sm"><i class="ri-add-circle-fill label-icon align-middle rounded-pill"></i> Add Report</a>
                @endcan
            </div>
            <div class="card-body">
