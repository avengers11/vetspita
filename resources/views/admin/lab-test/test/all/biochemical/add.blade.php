...
@section('master')
    ...
    <form action="{{ route('admin.lab-diognosis.biochemical.create') }}" method="post" enctype="multipart/form-data">
        @csrf 
                        ...
                        <table class="invoice-table table table-borderless table-nowrap mb-0">
                            <thead class="align-middle">
                                <tr class="table-active">
                                    ...
                                    <th scope="col" class="text-end">Comment</th>
