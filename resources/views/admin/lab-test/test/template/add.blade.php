...
<body>
    <form action="{{ route('admin.lab.test.template.add') }}" method="post">
        @csrf 
            ...
            <div class="prescription-body" style="width: 100%;">
                <div class="information-top" style="grid-template-columns: 100%">
                    <div class="box">
                        ...
                        <input type="text" name="prescription_name" id="prescription_name" class="title" required>
                    </div>
                </div>
                {{-- wrapper  --}}
                <div class="details-test-report-wrapper">
                    ...
                    <div class="test-report-wrapper">
                        <textarea name="prescription_content" id="ckeditor-classic">
