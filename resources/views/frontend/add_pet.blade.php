...
@section('content')
    @if (session('status'))
        <script>
            window.petSuccessMessage = @json(session('msg'));
        </script>
    @endif

    <div id="toast-message"
        class="hidden fixed top-5 right-5 bg-green-500 text-white px-4 py-3 rounded-md shadow-md transition-opacity duration-500">
        <span id="toast-text"></span>
    </div>

    <div>
        <div class="p-16 sm:p-28 bg-secondary/20 flex flex-col items-center">
            <h1 class="text-5xl font-medium mb-7 text-center leading-snug">Add new pet</h1>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="/add-pet"
                                class="ms-1 text-sm font-medium text-secondary_dark hover:text-secondary md:ms-2">Add
                                Pet</a>
                        </div>
                    </li>
                </ol>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="max-w-screen-2xl bg-white mx-auto py-28 px-10 space-y-10">
                <div class="flex flex-col items-center gap-5">
                    <div class="relative">
                        <label for="image"
                            class="absolute -bottom-2 -right-2 -translate-x-1/2 -translate-y-1/2 rounded-full p-2 bg-white/80 shadow-lg cursor-pointer">
                        ...
                        <img class="w-48 rounded-full border-4 border-secondary_dark p-5"
                            src="{{ Storage::url('pets\placeholder.png') }}" alt="">
                    </div>
                </div>
                <div class="grid grid-cols-3 gap-5">
                    ...
                    <div class="flex flex-col col-span-2">
                        ...
                        <input type="text" name="name" id="pet_name" placeholder="Type Pet Name"
                            class="border border-transparent outline-none focus:border focus:border-secondary focus:outline-none focus:ring-0 focus:shadow-none w-full p-4 bg-secondary/20"
                            required>
                    </div>
                    <div class="flex flex-col">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="number" name="age_year" id="age" placeholder="Type Age"
                            class="border border-transparent outline-none focus:border focus:border-secondary focus:outline-none focus:ring-0 focus:shadow-none w-full p-4 bg-secondary/20">
                    </div>
                    <div class="flex flex-col">
                        <label for="age" class="uppercase mb-2 font-medium text-secondary_dark">Age (Months)</label>
                        <input type="number" name="age_month" id="age" placeholder="Type Age"
                            class="border border-transparent outline-none focus:border focus:border-secondary focus:outline-none focus:ring-0 focus:shadow-none w-full p-4 bg-secondary/20">
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-center gap-10 py-4">
                            <div class="flex items-center">
                                <input checked id="vaccinated_true" type="radio" value="1" name="vaccinated"
                            ...
                            <div class="flex items-center">
                                <input id="vaccinated_false" type="radio" value="0" name="vaccinated"
                                    class="w-4 h-4 text-secondary_dark bg-gray-100 border-gray-300 focus:ring-secondary_dark focus:ring-2">
                    ...
                    <div class="flex flex-col">
                        <label for="vaccine_date" class="uppercase mb-2 font-medium text-secondary_dark">Vaccine
                            Date</label>
