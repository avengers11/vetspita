...
@section('content')
    <div>
        <div class="p-16 sm:p-28 bg-primary/30 flex flex-col items-center">
            <h1 class="text-5xl font-medium mb-7 text-center leading-snug">My Pets</h1>
                ...
                @foreach ($pets as $pet)
                    <div>
                        ...
                        <div class="py-6 text-center">
                            <h3 class="text-xl font-semibold mb-2 tracking-wide">{{ $pet->name }}</h3>
                            <p class="text-dark/60 font-medium text-sm uppercase tracking-wider">{{ $pet->species }}</p>
                            <p class="text-dark/60 font-medium text-sm uppercase tracking-wider">{{ $pet->unique_id }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
